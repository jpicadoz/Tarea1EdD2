...
public class UI {
    ...
    public void presentarMenu() {
        ...
        System.out.println("1. Insertar en cola FIFO");
        System.out.println("2. Push en pila");
        System.out.println("3. Pasar el tope de la pila a la cola");
        System.out.println("4. Pasar el inicio de la cola al tope de la pila");
